...
model = ElasticNet(alpha=0.1, l1_ratio=0.5, max_iter=10000, tol=0.0001)
...
x_exp = np.exp(predictions)
y_exp = np.exp(y_val)
MAE_exp = mean_absolute_error(x_exp, y_exp)
print('predictions exp. ', x_exp)
print('real exp. ', y_exp)
