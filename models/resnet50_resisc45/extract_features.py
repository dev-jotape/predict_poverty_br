...
module_url = "https://tfhub.dev/google/remote_sensing/resisc45-resnet50/1"
...
### Save data --------------------------------------------------------------
np.save('../../dataset/features/resnet50_resisc45/features_with_city_code.npy', features_finetuning)
np.save('../../dataset/features/resnet50_resisc45/population.npy', population_finetuning)
np.save('../../dataset/features/resnet50_resisc45/income.npy', income_finetuning)
np.save('../../dataset/features/resnet50_resisc45/density.npy', density_finetuning)
