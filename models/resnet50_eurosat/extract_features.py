...
### Save data --------------------------------------------------------------
np.save('../../dataset/features/resnet50_eurosat/features_with_city_code.npy', features_finetuning)
np.save('../../dataset/features/resnet50_eurosat/population.npy', population_finetuning)
np.save('../../dataset/features/resnet50_eurosat/income.npy', income_finetuning)
np.save('../../dataset/features/resnet50_eurosat/density.npy', density_finetuning)