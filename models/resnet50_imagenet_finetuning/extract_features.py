...
x_all = np.load('../../dataset/x_all_{}.npy'.format(version))
y_all = np.load('../../dataset/y_all_{}.npy'.format(version))
...
# GOOGLE IMAGES V1
# Test loss: 0.8524853587150574
# Test accuracy: 0.8038095235824585

# GOOGLE IMAGES V2
# Test loss: 1.863147497177124
# Test accuracy: 0.6438094973564148
